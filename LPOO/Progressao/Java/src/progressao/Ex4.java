...
public class Ex4 {
	...
	public static void main(String[] args) {
		...
		double b;
		double c;
		a = Double.parseDouble(JOptionPane.showInputDialog("Dada a formula de 2º grau forneça os valores\nDigite o valor de A"));
		...
		if (delta<0) {
			JOptionPane.showMessageDialog(null, "Não existe raiz para delta negativo");
