...
public class Ex2a {
	...
	public static void main(String[] args) {
		...
		int m2;
		double di;
		a = Integer.parseInt(JOptionPane.showInputDialog("Dada a formula matematica forneça devidamente os valores\nDigite o valor de A na formula"));
		...
		m2=(a2*j);
		di=(m/m2);
		JOptionPane.showMessageDialog(null,"O resultado é: "+di);
	}
}