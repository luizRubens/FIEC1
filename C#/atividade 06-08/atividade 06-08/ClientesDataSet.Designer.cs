...
namespace atividade_06_08 {
    ...
    public partial class ClientesDataSet : global::System.Data.DataSet {
        ...
        public partial class produtoDataTable : global::System.Data.TypedTableBase<produtoRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public produtoRow AddprodutoRow(string descricao, string marca, double preco_venda, double preco_custo, System.DateTime validade) {
...
namespace atividade_06_08.ClientesDataSetTableAdapters {
    ...
    public partial class ClienteTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::atividade_06_08.Properties.Settings.Default.ClientesConnectionString;
        }
    ...
    public partial class produtoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[produto] WHERE (([cod_produto] = @Original_cod_produto) AND ([descricao] = @Original_descricao) AND ([marca] = @Original_marca) AND ([preco_venda] = @Original_preco_venda) AND ([preco_custo] = @Original_preco_custo) AND ([validade] = @Original_validade))";
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[produto] ([descricao], [marca], [preco_venda], [preco_custo], [validade]) VALUES (@descricao, @marca, @preco_venda, @preco_custo, @validade);
SELECT cod_produto, descricao, marca, preco_venda, preco_custo, validade FROM produto WHERE (cod_produto = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[produto] SET [descricao] = @descricao, [marca] = @marca, [preco_venda] = @preco_venda, [preco_custo] = @preco_custo, [validade] = @validade WHERE (([cod_produto] = @Original_cod_produto) AND ([descricao] = @Original_descricao) AND ([marca] = @Original_marca) AND ([preco_venda] = @Original_preco_venda) AND ([preco_custo] = @Original_preco_custo) AND ([validade] = @Original_validade));
SELECT cod_produto, descricao, marca, preco_venda, preco_custo, validade FROM produto WHERE (cod_produto = @cod_produto)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT cod_produto, descricao, marca, preco_venda, preco_custo, validade FROM dbo" +
                ".produto";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        public virtual int Delete(int Original_cod_produto, string Original_descricao, string Original_marca, double Original_preco_venda, double Original_preco_custo, System.DateTime Original_validade) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(string descricao, string marca, double preco_venda, double preco_custo, System.DateTime validade) {
            if ((descricao == null)) {
        ...
        public virtual int Update(string descricao, string marca, double preco_venda, double preco_custo, System.DateTime validade, int Original_cod_produto, string Original_descricao, string Original_marca, double Original_preco_venda, double Original_preco_custo, System.DateTime Original_validade, int cod_produto) {
            if ((descricao == null)) {
                throw new global::System.ArgumentNullException("descricao");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[8].Value = ((double)(Original_preco_venda));
            this.Adapter.UpdateCommand.Parameters[9].Value = ((double)(Original_preco_custo));
            this.Adapter.UpdateCommand.Parameters[10].Value = ((System.DateTime)(Original_validade));
            this.Adapter.UpdateCommand.Parameters[11].Value = ((int)(cod_produto));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string descricao, string marca, double preco_venda, double preco_custo, System.DateTime validade, int Original_cod_produto, string Original_descricao, string Original_marca, double Original_preco_venda, double Original_preco_custo, System.DateTime Original_validade) {
            return this.Update(descricao, marca, preco_venda, preco_custo, validade, Original_cod_produto, Original_descricao, Original_marca, Original_preco_venda, Original_preco_custo, Original_validade, Original_cod_produto);
        }
    }
